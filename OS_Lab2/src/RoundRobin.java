public class RoundRobin {
    ...
    static int[] calculateWaitingTime(int burstTime[], int quantum)
    {
    ...
    static int[] calculateTurnAroundTime(int burstTime[], int waitingTime[])
    {
        int numberOfElements=burstTime.length;
    ...
    // turnaround times
    static void printAverageTime(int burstTime[], int quantum)
    {
        ...
        int[] waitingTime = calculateWaitingTime(burstTime, quantum);

        // Find turn around time for all processes
        int[] turnAroundTime = calculateTurnAroundTime(burstTime, waitingTime);
    ...
    public static void main(String[] args)
    {
        ...
        printAverageTime(burstTime, quantum);
    }
}
